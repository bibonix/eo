...
```text
to-java.xsl              48491  34.39%
classes.xsl              39713  28.17%
set-locators.xsl         11094  7.87%
attrs.xsl                8399   5.96%
set-original-names.xsl   8164   5.79%
data.xsl                 7647   5.42%
anonymous-to-nested.xsl  5982   4.24%
tests.xsl                5847   4.15%
package.xsl              5663   4.02%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-04-24 at 11:52,
on Linux with 4 CPUs.
The total is 141000 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/24887775201
